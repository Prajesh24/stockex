...
import '../../features/watchlist/presentation/state/watchlist_state.dart';

import '../../features/watchlist/presentation/viewmodel/watchlist_viewmodel.dart';
...
class _WatchlistPageState extends ConsumerState<WatchlistPage> {
  ...
  Widget _buildWatchlistCard(WatchlistEntity stock, WatchlistViewModel notifier) {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () => _showDeleteConfirmation(context, stock.symbol, notifier),
                child: const Icon(
            ...
            child: GridView.count(
              ...
              children: [
                ...
                _buildDataItem(
                  ...
                  valueColor: isPositive ? const Color(0xFF059669) : const Color(0xFFDC2626),
                ),
                _buildDataItem(
                  'Ch%',
                ...
                _buildDataItem('Prev Close', stock.previousClose.toStringAsFixed(2)),
              ],
            ),
          ),
        ],
  ...
  void _showDeleteConfirmation(BuildContext context, String symbol, WatchlistViewModel notifier) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        backgroundColor: const Color(0xFF1E1E1E),
        title: const Text('Remove Stock', style: TextStyle(color: Colors.white)),
        content: Text(
